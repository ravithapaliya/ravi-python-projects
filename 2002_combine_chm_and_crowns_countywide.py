...
base_folder = r"F:\MYPHDRESEARCHOUTPUTS\Batch_Results2002_1m_Final"
...
output_folder = r"F:\MYPHDRESEARCHOUTPUTS\Countywide_Combined_Results_2002\QOL_NPA_Min2m_Outputs"
os.makedirs(output_folder, exist_ok=True)

county_output_folder = r"F:\MYPHDRESEARCHOUTPUTS\Countywide_Combined_Results_2002"
...
print("Loading building footprints if available...")
use_buildings = os.path.exists(building_shapefile)
...
if use_buildings:
    ...
    print("  No 2002 building shapefile found. Building removal will be skipped.")
    buildings = None
        ...
        if use_buildings:
            ...
            if len(possible_idx) > 0:
                ...
                if not bldg_subset.empty:
                    ...
                    drop_cols = [
                        c for c in ["index_right", "building_hit"]
                        if c in crowns_all.columns
                    ]
