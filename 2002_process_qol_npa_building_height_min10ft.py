...
base_folder = r"F:\MYPHDRESEARCHOUTPUTS\building_height_results_2002"
...
output_folder = r"F:\MYPHDRESEARCHOUTPUTS\Countywide_Combined_Results_2002\QOL_NPA_BuildingHeight_Min10ft_Max900ft_Outputs"
...
building_fp = building_fp[
    building_fp.geometry.notnull() & ~building_fp.geometry.is_empty
].copy()
...
if len(npa_building_files) == 0:
    ...
    if len(building_list) > 0:
        ...
        county_buildings = county_buildings[
            county_buildings.geometry.notnull() &
            ~county_buildings.geometry.is_empty
        ].copy()
