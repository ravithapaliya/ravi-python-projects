...
base_output_folder = r"C:\Users\ravit\Documents\tree research work new\Batch_Results2002_1m_Final"
...
for filename in reflective_files:
    ...
    out_chm = os.path.join(tile_folder, f"{tile_id}_CHM_1m_2002.tif")
    out_shp = os.path.join(tile_folder, f"{tile_id}_tree_crowns_1m_2002.shp")
    ...
    try:
        ...
        del las_ref, las_be, rx, ry, rz, gx, gy, gz, dtm, dsm, chm, smoothed, labels
        gc.collect()
